...
function DuDashBoard({ employeeInfo, employeeList,leaveData,getLeaveData,empTransactions,getAllEmpTransactions,isHr}) {
...
export default memo(DuDashBoard);
