...
function HrTeamview({employeeInfo,employeeList,leaveData,getLeaveData,isHr,empTransactions,getAllEmpTransactions}) {
        ...
        <div className={classes.tabRoot}>
          ...
          >
            <TabPanel value={value} index={0} dir={theme.direction}>
              <Dashboardcomp employeeInfo={employeeInfo} Dashboardfor="HR" leaveData={leaveData} getLeaveData={getLeaveData} employeeList={employeeList}/>
            </TabPanel>
...
export default memo(HrTeamview);
